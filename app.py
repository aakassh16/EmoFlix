...
TMDB_API_KEY = '9ea1d53c7f38b94b509fdd2ccade0721'
app = Flask(__name__)
        ...
        if input_genre is not None:
            ...
            if genre_id is None:
                ...
                if response.status_code == 200:
                    data = response.json()
                    movies = [{'id': movie['id'],'title': movie['title'], 'poster_path': movie['poster_path'],'vote_average' :['vote_average']} for movie in
                              data['results']]
